	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (conn != null) {
			...
			if (flag == 1) { // Preleva tutte le richieste
				try {
					Integer requestWorkingAdmin = Integer
						...
						if (count > 0) {
							...
							while (r.next()) {
								...
								content += "    <td class='text-center'>" + sdf.format(r.getDate("release_date"))
										+ "</td>";
								content += "    <td class='text-center'>" + sdf.format(r.getDate("expiry_date"))
										+ "</td>";
								...
								if (r.getInt("id_state") == requestWorkingAdmin) { // Se è in lavorazione dall'admin
									...
									content += "<button class=\"btn btn-primary btn-action toWorkingEducationAdvice accept"
									...
									content += "<button class=\"btn btn-primary btn-action toWorkingEducationAdvice refuse"
