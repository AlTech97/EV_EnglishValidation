...
<link href="css/styleEV.css" rel="stylesheet">
                                	...
                                	<div class="mega-menu-bar">
                                        ...
                                        <div class="mega-menu-carousel owl-carousel owl-theme">
                                            ...
                                            <div class="news-block-nine">
                                                <div class="inner-box">
                                                    <div class="image">
                                                        <a href="#"><img src="images/resource/news-44.jpg" alt="" /></a>
                                                        <div class="category"><a href="#">Travel</a></div>
                                                    </div>
                                                    <div class="lower-box">
                                                        <h3><a href="#">Selena Gomez and Lady Gaga join Billboard campaign to stop violence</a></h3>
                        	...
                        	<div class="dropdown">
                                ...
                                <div class="dropdown-menu pull-right cart-panel" aria-labelledby="dropdownMenu3">
                                    ...
                                    <div class="cart-product">
                                        <div class="inner">
                                        	<div class="cross-icon"><span class="icon fa fa-remove"></span></div>
                                            <div class="image"><img src="images/resource/post-thumb-4.jpg" alt="" /></div>
                                            <h3><a href="#">Woolen T-shirt</a></h3>
                                            <div class="quantity-text">Quantity 1</div>
                                            <div class="price">$99.00</div>
                                        </div>
                ...
                <div class="clearfix">
                    ...
                    <div class="slide-column col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="news-block-three style-two">
                            <div class="inner-box">
                                <div class="image">
                                    <img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-15.jpg" alt="" />
                                    <div class="overlay-box">
                                        <div class="content">
                                            <div class="tag"><a href="blog-single.html">Travel</a></div>
                                            <h3><a href="blog-single.html">Yulin Creative meat festival begins in China amid widespread criticism</a></h3>
                                            <ul class="post-meta">
                        ...
                        <div class="row clearfix">
                        	<div class="inner-slide col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="news-block-three style-three">
                                    <div class="inner-box">
                                        <div class="image">
                                            <img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-16.jpg" alt="" />
                                            <div class="overlay-box">
                                                <div class="content">
                                                    <div class="tag"><a href="blog-single.html">Design</a></div>
                                                    <h3><a href="blog-single.html">Selena Gomez and Lady Gaga join Billboard campaign to stop violence</a></h3>
                                                    <ul class="post-meta">
                                                        <li><span class="icon qb-clock"></span>March 17, 2016</li>
                                                        <li><span class="icon fa fa-comment-o"></span>9</li>
                                                        <li><span class="icon qb-eye"></span>2470</li>
                            ...
                            <div class="inner-slide col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="news-block-three style-four">
                                    <div class="inner-box">
                                        <div class="image">
                                            <img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-17.jpg" alt="" />
                                            <div class="overlay-box">
                                                <div class="content">
                                                    <div class="tag"><a href="blog-single.html">Style</a></div>
                                                    <h3><a href="blog-single.html">Gareth Bale has last laugh as Universal</a></h3>
                                                    <ul class="post-meta">
                                                        <li><span class="icon qb-clock"></span>March 17, 2016</li>
                                                        <li><span class="icon fa fa-comment-o"></span>9</li>
                                                        <li><span class="icon qb-eye"></span>2470</li>
                            ...
                            <div class="inner-slide col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="news-block-three style-four">
                                    <div class="inner-box">
                                        <div class="image">
                                            <img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-18.jpg" alt="" />
                                            <div class="overlay-box">
                                                <div class="content">
                                                    <div class="tag"><a href="blog-single.html">Fashion</a></div>
                                                    <h3><a href="blog-single.html">Priyanka Chopra got what photoshopped?</a></h3>
                                                    <ul class="post-meta">
                                                        <li><span class="icon qb-clock"></span>March 17, 2016</li>
                                                        <li><span class="icon fa fa-comment-o"></span>9</li>
                                                        <li><span class="icon qb-eye"></span>2470</li>
        	...
        	<div class="row clearfix">
                ...
                <div class="content-side pull-right col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            ...
                            <div class="slide">
                                ...
                                <div class="column col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="news-block-two with-margin">
                                        <div class="inner-box">
                                            <div class="image">
                                                <a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-5.jpg" alt="" /></a>
                                    ...
                                    <article class="widget-post">
                                        ...
                                        <div class="text"><a href="blog-single.html">Wooden skyscrapers are springing up across the world</a></div>
                                        <div class="post-info">August 16, 2016</div>
                                    </article>
                                    
                                    <!--Widget Post-->
                                    <article class="widget-post">
                                        <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/post-thumb-6.jpg" alt=""></a></figure>
                                        <div class="text"><a href="blog-single.html">New York state and Francisco are also close to cracking</a></div>
                                        <div class="post-info">August 17, 2016</div>
                                    </article>
                                ...
                                <div class="column col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="news-block-two with-margin">
                                        <div class="inner-box">
                                            <div class="image">
                                                <a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-6.jpg" alt="" /></a>
                                    ...
                                    <!--Widget Post-->
                                    <article class="widget-post">
                                        <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/post-thumb-7.jpg" alt=""></a></figure>
                                        <div class="text"><a href="blog-single.html">Critics of sites like Airbnb have long claimed that the remove</a></div>
                                        <div class="post-info">August 18, 2016</div>
                                    </article>
                                    
                                    <!--Widget Post-->
                                    <article class="widget-post">
                                        <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/post-thumb-8.jpg" alt=""></a></figure>
                                        <div class="text"><a href="blog-single.html">Five of the displaced tenants filed a lawsuit against</a></div>
                                        <div class="post-info">August 19, 2016</div>
                                    </article>
                    ...
                    <section class="adds-block text-center">
                    	<div class="image">
                        	<a href="#"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/header-add.jpg" alt="" /></a>
                        </div>
                    </section>
                    <!--End Adds Section-->
                    <br><br>
                    ...
                    <section class="featured-block-section">
                        ...
                        <div class="single-item-carousel owl-carousel owl-theme">
                            ...
                            <div class="news-block-three style-three">
                                <div class="inner-box">
                                    <div class="image">
                                        <img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-19.jpg" alt="" />
                                        <div class="overlay-box">
                                            <a href="blog-single.html" class="play-btn"><span class="icon qb-play-arrow"></span></a>
                                            <div class="content">
                                                <div class="tag"><a href="blog-single.html">Travel</a></div>
                                                <h3><a href="blog-single.html">Develop a new Silk Road through Russia Study the New Digital Course</a></h3>
                                                <ul class="post-meta">
                    ...
                    <div class="latest-news-section">
                    	...
                    	<div class="row clearfix">
                            ...
                            <div class="news-block-two with-margin col-md-6 col-sm-6 col-xs-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-21.jpg" alt="" /></a>
                                        <div class="category"><a href="blog-single.html">Design</a></div>
                                    </div>
                                    <div class="lower-box">
                                        <h3><a href="blog-single.html">Does this doctor hold the secret to ending malaria applications?</a></h3>
                            ...
                            <div class="news-block-two with-margin col-md-6 col-sm-6 col-xs-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-22.jpg" alt="" /></a>
                            ...
                            <div class="news-block-two with-margin col-md-6 col-sm-6 col-xs-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-23.jpg" alt="" /></a>
                            ...
                            <div class="news-block-two with-margin col-md-6 col-sm-6 col-xs-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-24.jpg" alt="" /></a>
                            ...
                            <div class="news-block-two with-margin col-md-6 col-sm-6 col-xs-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-25.jpg" alt="" /></a>
                	...
                	<aside class="sidebar default-sidebar left-sidebar">
                        ...
                        <div class="sidebar-widget recent-news-widget">
                            ...
                            <div class="news-block-five">
                                <div class="inner-box">
                                    <div class="image">
                                        <a href="#"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-14.jpg" alt="" /></a>
                                        <div class="category"><a href="#">Travel</a></div>
                                    </div>
                                    <div class="lower-box">
                        ...
                        <div class="sidebar-widget sidebar-adds-widget">
                        	<div class="adds-block" style="background-image:url(images/resource/add-image-2.jpg);">
                            	<div class="inner-box">
                                    ...
                                    <div class="tabs-content">
                                        ...
                                        <div class="tab active-tab" id="prod-popular">
                                            <div class="content">
                                                ...
                                                <article class="widget-post">
                                                    <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/post-thumb-9.jpg" alt=""></a><div class="overlay"><span class="icon qb-play-arrow"></span></div></figure>
                                                    <div class="text"><a href="blog-single.html">Priyanka Chopra got her what photoshopped?</a></div>
                                                    <div class="post-info">April 26, 2016</div>
                                                </article>
                        ...
                        <div class="sidebar-widget sidebar-comment-widget">
                            ...
                            <article class="widget-comment-post">
                                <figure class="post-thumb"><a href="blog-single.html"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/comment.jpg" alt=""></a></figure>
                                <div class="text"><a href="blog-single.html">Priyanka Chopra got her what photoshopped?</a></div>
                                <div class="post-info">April 01, 2016</div>
                            </article>
                            <article class="widget-comment-post">
            	...
            	<div class="row clearfix">
                    ...
                    <div class="widget-column col-md-4 col-sm-6 col-xs-12">
                    	<div class="footer-widget reviews-widget">
                            ...
                            <div class="review-block">
                            	<div class="inner-box">
                                	<div class="image"><a href="#"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/review-1.jpg" alt="" /></a></div>
                                    <div class="text"><a href="#">A young woman holding a beautiful umbrella in the rain</a></div>
                                    <span class="ratings">
                                    	<span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                            ...
                            <div class="review-block">
                            	<div class="inner-box">
                                	<div class="image"><a href="#"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/review-2.jpg" alt="" /></a></div>
                                    <div class="text"><a href="#">Study the New Digital Course Developed with Google</a></div>
                                    <span class="ratings">
                                    	<span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                            ...
                            <div class="review-block">
                            	<div class="inner-box">
                                	<div class="image"><a href="#"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/review-3.jpg" alt="" /></a></div>
                                    <div class="text"><a href="#">A modern day security strategy for your computer</a></div>
                                    <span class="ratings">
                                    	<span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                    ...
                    <div class="widget-column col-md-4 col-sm-6 col-xs-12">
                    	<div class="footer-widget isntagram-widget">
                            ...
                            <div class="clearfix">
                            	<figure class="image"><a href="images/resource/news-1.jpg" class="lightbox-image"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/instagram-1.jpg" alt=""></a></figure>
                                <figure class="image"><a href="images/resource/news-2.jpg" class="lightbox-image"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/instagram-2.jpg" alt=""></a></figure>
                                <figure class="image"><a href="images/resource/news-3.jpg" class="lightbox-image"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/instagram-3.jpg" alt=""></a></figure>
                                <figure class="image"><a href="images/resource/news-4.jpg" class="lightbox-image"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/instagram-4.jpg" alt=""></a></figure>
                                <figure class="image"><a href="images/resource/news-1.jpg" class="lightbox-image"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/instagram-5.jpg" alt=""></a></figure>
                                <figure class="image"><a href="images/resource/news-2.jpg" class="lightbox-image"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/instagram-6.jpg" alt=""></a></figure>
                                <figure class="image"><a href="images/resource/news-3.jpg" class="lightbox-image"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/instagram-7.jpg" alt=""></a></figure>
                                <figure class="image"><a href="images/resource/news-4.jpg" class="lightbox-image"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/instagram-8.jpg" alt=""></a></figure>
                            </div>
                        </div>
                    ...
                    <div class="widget-column col-md-4 col-sm-6 col-xs-12">
                    	<div class="footer-widget popular-widget">
                            ...
                            <div class="news-info">
                            	<div class="inner-box">
                                	<div class="image">
                                    	<img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-post-1.jpg" alt="" />
                                        <a class="overlay" href="#"><span class="icon fa fa-play"></span></a>
                                    </div>
                                    <div class="text"><a href="#">Study the New Digital Course Developed with Google</a></div>
                                    <div class="post-date">March 15, 2016</div>
                                </div>
                            </div>
                            ...
                            <div class="news-info">
                            	<div class="inner-box">
                                	<div class="image">
                                    	<img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-post-2.jpg" alt="" />
                                        <a class="overlay" href="#"><span class="icon fa fa-play"></span></a>
                                    </div>
                                    <div class="text"><a href="#">A young woman holding a beautiful umbrella in the rain</a></div>
                                    <div class="post-date">March 16, 2016</div>
                            ...
                            <div class="news-info">
                            	<div class="inner-box">
                                	<div class="image">
                                    	<img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="images/resource/news-post-3.jpg" alt="" />
                                        <a class="overlay" href="#"><span class="icon fa fa-play"></span></a>
                                    </div>
                                    <div class="text"><a href="#">Gain Essential Creative Project Management Training</a></div>
