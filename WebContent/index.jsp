                            ...
                            <div class="content">
                                <div class="news-block-seven">
									...
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 index-container">
										...
										<a href=".\login.jsp" class="btn btn-primary btn-lg btn-block" role="button" aria-pressed="true">Accedi</a>
										<p> </p>
										<a href="_areaStudent\signUp.jsp" class="btn btn-primary btn-lg btn-block" role="button" aria-pressed="true">Registrati</a>
										<p> </p>
									</div>
